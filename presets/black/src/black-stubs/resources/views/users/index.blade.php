                ...
                <div class="wrapper">
                        <div class="sidebar">
                                <div class="sidebar-wrapper">
                                    <div class="logo">
                                        <a href="{{ route('home') }}" class="simple-text logo-mini">{{ _('RM') }}</a>
                                        <a href="{{ route('home') }}" class="simple-text logo-normal">{{ _('RideMate') }}</a>
                                    </div>
                                    <ul class="nav">
                                        <li>
                                            <a href="{{ route('home') }}">
...
<div class="container-fluid">
    ...
    {{-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBwmu2sNtB0IXR-Aw23GJBI0gJjL5itRgk&libraries=places"></script> --}}
    <!-- Chart JS -->
