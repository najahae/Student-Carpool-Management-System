@extends('passenger.layouts.app', ['class' => 'login-page', 'page' => __('RideMate'), 'contentClass' => 'login-page'])
...
@section('content')
    ...
    <div class="col-lg-4 col-md-6 ml-auto mr-auto">
        <form class="form" method="post" action="{{ route('passenger.login') }}">
            @csrf
            ...
            <div class="text-center">
                <h6>
                    <a href="{{ route('passenger.register') }}" class="link footer-link">{{ __('Create Account') }}</a>
                </h6>
                <h6>
